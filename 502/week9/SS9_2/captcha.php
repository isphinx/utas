...
//the header content-type will help you to make the output of this php into image.
...
$bgimg =imagecreatefrompng("./img/img.png");
...
imagestring($bgimg, 5, 50, 30, $randomstr, $textcolor);// Draw a random string horizontally 
